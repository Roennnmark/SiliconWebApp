...
public class ProfileImageService(UserManager<UserEntity> userManager, DataContext dataContext, IConfiguration configuration)
{
        ...
        try
        {
            if (user != null && file != null && file.Length != 0)
            {
                ...
                if (userEntity != null)
                {
                    ...
                    userEntity.ProfilePictureUrl = fileName;
